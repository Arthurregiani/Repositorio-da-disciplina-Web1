...
function Labirinto(Width, Height) {
    ...
    function defineMaze() {
        ...
        while (!isComp) {
            move = false;
            mapaLab[pos.x][pos.y].visited = true;
            ...
            for (index = 0; index < dirs.length; index++) {
                ...
                if (nx >= 0 && nx < largura && ny >= 0 && ny < altura) {
                    ...
                    if (!mapaLab[nx][ny].visited) {
                        //Carve through walls from this tile to next
                        mapaLab[pos.x][pos.y][direction] = true;
                        mapaLab[nx][ny][modDir[direction].o] = true;

                        //Set Currentcell as next cells Prior visited
                        mapaLab[nx][ny].priorPos = pos;
            ...
            if (!move) {
                ...
                pos = mapaLab[pos.x][pos.y].priorPos;
            }
...
function makeMaze() {
    ...
    cellSize = mazeCanvas.width / difficulty;
    maze = new Labirinto(difficulty, difficulty);
    draw = new DrawMaze(maze, ctx, cellSize, finishSprite);
    player = new Player(maze, mazeCanvas, cellSize, displayVitória, sprite);
